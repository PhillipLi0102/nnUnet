...
class ExperimentPlanner(object):
    ...
    def determine_resampling(self, *args, **kwargs):
        ...
        configuration
        """
        def no_op_resampling(data, current_spacing, new_spacing, **kwargs):
            return data

        resampling_data = no_op_resampling
        resampling_data_kwargs = {}
        resampling_seg = no_op_resampling
    ...
    def determine_segmentation_softmax_export_fn(self, *args, **kwargs):
        ...
        resampling_fn = no_op_resampling
